        ...
        <Grid item>
            <Paper elevation={10} style={{width: 350, padding: 20, background: 'rgba(255, 255, 255, 0.85)', border: 'solid', borderWidth: '4px', borderColor: "#1a237e"}}>
                <Grid container justifyContent='center' alignItems='center' spacing={3}>
                    <Grid item xs={12}>
                        <Typography style={{ color: "black", fontWeight: 500, fontFamily: "Segoe UI"}} variant="h5" >Sucessfully created survey!</Typography>
                    </Grid>
                    <Grid item xs={12}>
                    ...
                    <Grid item xs={6}>
                        <Button href="/surveys" variant='contained'>Explore Surveys</Button>
                    </Grid>
                </Grid>
            </Paper>
        </Grid>
